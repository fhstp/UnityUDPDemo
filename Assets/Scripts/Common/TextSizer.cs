    ...
    public class TextSizer : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            if (text != null && (text.text != lastText || lastSize != rt.rect.size || forceRefresh))
            {
                ...
                if ((controlAxes & Mode.Horizontal) != 0) rt.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, preferredSize.x);
                if ((controlAxes & Mode.Vertical) != 0) rt.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, preferredSize.y);
